    ...
    <div>
        ...
        <div className='grid grid-cols-3 lg:grid-cols-6 gap-4'>
            <div className='p-6 rounded-[4px] border border-gray-200'>
                <Image src={group} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
            <div className='p-6 rounded-[4px] bg-[#FF3811] border border-gray-200'>
                <Image src={group5} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
            <div className='p-6 rounded-[4px] border border-gray-200'>
                <Image src={group4} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
            <div className='p-6 rounded-[4px] border border-gray-200'>
                <Image src={group3} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
            <div className='p-6 rounded-[4px] border border-gray-200'>
                <Image src={group1} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
            <div className='p-6 rounded-[4px] border border-gray-200'>
                <Image src={group2} alt='group' width={24} height={34} />
                <p>Expert Team</p>
            </div>
        </div>
    </div>
