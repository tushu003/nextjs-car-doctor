...
export default function Services() {
  // const serviceCollection= dbConnect("services-collection");
    ...
    },
    {
      ...
      facility: [
        ...
        },
        {
          name: "Quality Cost Service",
          details:
            "Fuga numquam tulla nam, facere neque dignissimos ab esse magni accusamus eveniet ad corrupti, architecto nostrum.",
        },
      ],
    },
    {
  ...
  return (
    <div>
      ...
      <h2 className="text-black font-bold text-center text-2xl mb-1">
        Our Service Area
      </h2>
      ...
      <div className="text-center">
        <button className="text-[#FF3811] border border-[#FF3811] px-3 mb-8 py-2 rounded-md">
          More Services
        </button>
      </div>
    </div>
